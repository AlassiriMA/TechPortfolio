...
const ProjectCard = ({ project }: ProjectCardProps) => {
  const { title, description, imgSrc, imgAlt, technologies, demoLink, githubLink } = project;
      ...
      <div className="p-6">
        ...
        <div className="flex space-x-4">
          {demoLink && (
            <a 
              href={demoLink} 
              className="text-gold flex items-center hover:underline"
              target="_blank"
          ...
          {githubLink && (
            <a 
              href={githubLink} 
              className="text-darkgray flex items-center hover:text-gold transition-colors"
              target="_blank"
              rel="noopener noreferrer"
