      ...
      <div className="container mx-auto px-6">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex space-x-4">
              <a href="https://github.com/" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <i className="ri-github-fill text-2xl text-gray-300 hover:text-glossy-gold transition-colors duration-300"></i>
              </a>
              <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <i className="ri-linkedin-box-fill text-2xl text-gray-300 hover:text-glossy-gold transition-colors duration-300"></i>
              </a>
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <i className="ri-twitter-fill text-2xl text-gray-300 hover:text-glossy-gold transition-colors duration-300"></i>
              </a>
              <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <i className="ri-instagram-fill text-2xl text-gray-300 hover:text-glossy-gold transition-colors duration-300"></i>
              </a>
              <a href="https://dev.to/" target="_blank" rel="noopener noreferrer" aria-label="Dev.to">
                <i className="ri-code-box-fill text-2xl text-gray-300 hover:text-glossy-gold transition-colors duration-300"></i>
              </a>
              <a href="https://medium.com/" target="_blank" rel="noopener noreferrer" aria-label="Medium">
                <i className="ri-medium-fill text-2xl text-gray-300 hover:text-glossy-gold transition-colors duration-300"></i>
              </a>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-400">
          ...
          <div className="mt-4 md:mt-0 flex flex-wrap justify-center gap-4">
            <a href="#" className="text-sm text-gray-400 hover:text-glossy-gold transition-colors duration-300">Privacy Policy</a>
            <span className="hidden md:inline text-gray-600">|</span>
            <a href="#" className="text-sm text-gray-400 hover:text-glossy-gold transition-colors duration-300">Terms of Service</a>
            <span className="hidden md:inline text-gray-600">|</span>
            <a href="#" className="text-sm text-gray-400 hover:text-glossy-gold transition-colors duration-300">Sitemap</a>
          </div>
          <p className="mt-4 md:mt-0 text-gray-400">Designed with <span className="text-glossy-gold">♥</span> by Mohammad</p>
        </div>
      </div>
    </footer>
  );
